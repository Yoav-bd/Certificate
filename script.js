...
<div style="text-align: center; direction: ltr;">
    <!-- Outermost black box -->
    <div
        style="width: 170mm; height: 250mm; margin: 9.8mm; padding: 1.2mm; text-align: center; font-family: Arial, sans-serif; border: 2px solid black; box-sizing: border-box; page-break-inside: avoid;">
        <!-- First inner black box -->
        <div
            style="width: 100%; height: 100%; padding: 0.4mm; border: 0.6px solid black; box-sizing: border-box; page-break-inside: avoid;">
            <!-- Second inner black box -->
            <div style=" position: relative; width: 100%; height: 100%; border: 0.6px solid black; box-sizing: border-box; page-break-inside: avoid;">
           
                <!-- Div 1: Certificate Title -->
                <div style="margin-top: 18mm; text-align: center;">
                    <h1 style="font-weight: 400; font-family: 'CaslonIonic'; font-size: 26pt; line-height: 1.2;">
                        <span style="display: block;">CERTIFICATE OF</span>
                        <span style="display: block;">AUTHENTICITY</span>
                    </h1>
                    <p style="margin-top: 9.5mm; margin-bottom: 14mm; font-weight: 400; font-family: 'CaslonIonic'; font-size: 10pt; line-height: 1.3;">
                    THIS DOCUMENT CERTIFIES THAT THIS ARTWORK IS <br> AN ORIGINAL WORK BY THE ARTIST
                    </p>
                </div>

                <!-- Div 2: Artwork Image -->
                <div style="width: 110mm; height: 56mm; margin: 0 auto 15.5mm; display: flex; justify-content: center; align-items: center;">
                     <img src="${imageUrl}" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                </div>

                <!-- Div 3: Artist Name and Artwork Title -->
                <div style="text-align: center; margin-bottom: 10.5mm;">
                     <p style="font-family: 'CaslonIonic'; font-size: 10pt; text-transform: uppercase; margin: 0;">${artistName}</p>
                     <p style="margin-top: 1.5mm; font-family: 'QuadrantMono'; font-size: 9pt;">${artworkTitle}</p>
                </div>

            <div
                    style="position: absolute; bottom: 0px; width: 100%; height: 32%; margin: 0px auto; margin-bottom: 0px; display: flex; flex-direction: column; justify-content: space-between; align-items: center;">

                <!-- Div 4: Artwork Details -->
                 <div style="text-align: center; font-family: 'QuadrantMono'; font-size: 9pt; font-weight: 300; margin-bottom: 3.5mm;">
                    <p style="margin-bottom: 0.1mm;">Edition: ${edition}</p>
                    <p style="margin-bottom: 0.1mm;">Media: ${media}</p>
                    <p style="margin-bottom: 0.1mm;">Dimensions: ${dimensions}</p>
                    <p style="margin-bottom: 0.1mm;">Year Created: ${yearCreated}</p>
                    ${yearPrinted ? `<p style="margin-bottom:0mm;">Year Printed: ${yearPrinted}</p>` : ''}
                </div>

                <!-- Div 5: Signature and Footer -->
             <div style=" width: 100%; padding-bottom: 5mm;">
                <div style="width: 230px; height: 60px; margin: 0px auto; display: flex; justify-content: center; align-items: center;">
                    <img src="${signatureImage}" alt="Signature"
                        style="max-width: 100%; max-height: 100%; object-fit: contain;">
                </div>
                <div style="width: 50%; border-top: 0.6px solid black; margin: 0 auto;"></div>
                <div style="font-family:'QuadrantMono'; font-weight: 300; font-size: 10px; margin-top: 4px;">${artistName}</div>
            </div>
                <div style="width: 95%; height:12mm; border-top: 0.6px solid black; display: flex; align-items: center; justify-content: space-between; overflow: visible;">

                        <svg style=" flex-shrink: 0; " width="200" height="19" viewBox="40 0 53 13"
                        ...
                        <p style=" font-weight: bold; font-size: 7pt; margin: 0; text-align: left; line-height: 1.2; font-family: 'SctoGroteskA', sans-serif;">
    ...
    var opt = {
        margin: [0,0,0,0],  // Set margins to avoid cutting off the edges
        filename: 'Certificate_of_Authenticity.pdf',
        image: { type: 'jpeg', quality: 0.98 },
        html2canvas: { scale: 4.2 },  // Increased scaling for better resolution
        jsPDF: { unit: 'mm', format: [270, 190], orientation: 'portrait' }  // Using 270x190mm paper size and orientation
    };
