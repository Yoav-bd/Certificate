    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <h1
                    style=" font-weight:400; font-family:'SctoGroteskA'; font-size: 45px; margin: 10px; margin-top: 60px;  line-height: 1.2;">
                    <span style="display: block;">CERTIFICATE OF</span>
                    <span style="display: block;">AUTHENTICITY</span>
                </h1>
                <p
                    style="margin-top: 30px; margin-bottom:50px; font-weight:400; font-family:'SctoGroteskA'; font-size: 18px;">
                ...
                <p style="margin-top: 70px; font-family:'SctoGroteskA'; font-size: 16px;">${artistName}</p>
                <p style="margin-top: -20px; margin-bottom: 30px; font-family:'SctoGroteskA';  font-size: 15px;">
                    ${artworkTitle}</p>
                <p
                    style="margin-top: 10px; margin-bottom: 15px; font-size: 18px; font-family:'SctoGroteskA'; font-weight: 300; font-size: 15px;">
                    Edition: ${edition}</p>
                <p
                    style="margin-top: -15px; margin-bottom: 15px; font-size: 18px; font-family:'SctoGroteskA'; font-weight: 300; font-size: 15px;">
                    Media: ${media}</p>
                <p
                    style="margin-top: -15px; margin-bottom: 15px; font-size: 18px; font-family:'SctoGroteskA'; font-weight: 300; font-size: 15px;">
            ...
            : `<div style="margin-bottom: 35px;"></div>`}
                ...
                <div style="font-family:'SctoGroteskA'; font-weight: 300; font-size: 10px;">${artistName}</div>
